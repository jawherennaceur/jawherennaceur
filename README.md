...
| Company | Role | Impact |
| :--- | :--- | :--- |
| **Deloitte** | AI Engineering Intern | Built a Multi-Agent Salesforce Copilot using **GraphRAG (Neo4j)** and **MCP** for seamless tool integration. |
| **Class Quiz** | AI Engineer | Engineered an OCR + LLM pipeline reducing data prep time by **70%**. Built enterprise RAG agents with Gemini. |
| **Data Scale** | AI/ML Intern | Developed a Vertex AI support agent and automated ML pipelines with **LightGBM** and **Flask**. |
...
| **LLMs & RAG** | OpenAI, Gemini, Claude, LlamaIndex, Vector DBs (Chroma, Pinecone) |
| **Databases** | **Neo4j (GraphRAG)**, PostgreSQL, MongoDB |
| **Backend & Cloud** | FastAPI, Flask, GCP (Vertex AI), Docker |
| **ML Frameworks** | PyTorch, Scikit-learn, LightGBM, Pandas |
...
<div align="center">
<img width="48%" src="https://github-readme-streak-stats.herokuapp.com/?user=jawherennaceur&theme=react&border_radius=10" />
<img width="48%" src="https://github-readme-stats.vercel.app/api?username=jawherennaceur&show_icons=true&theme=react&border_radius=10&count_private=true" />
</div>
